...
# from oci_client import LLM_Client
...
class CurrencyAgent:
    ...
    def __init__(self):
        ...
        # self.model = oci_llm.build_llm_client()
    ...
    async def stream(self, query, context_id) -> AsyncIterable[dict[str, Any]]:
        ...
        config = {'configurable': {'thread_id': context_id},'callbacks':[fuse_handler.get_handler()],'metadata':{'langfuse_session_id':"1"}}
